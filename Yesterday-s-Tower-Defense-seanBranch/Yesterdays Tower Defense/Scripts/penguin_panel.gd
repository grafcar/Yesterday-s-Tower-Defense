...
func _on_gui_input(event):
	...
	if event is InputEventMouseButton and event.button_mask == 1 and Game.Gold >= 10:
		add_child(tempTower)
	...
	elif event is InputEventMouseMotion and event.button_mask == 1 and Game.Gold >= 10:
	...
	elif event is InputEventMouseButton and event.button_mask == 0 and Game.Gold >= 10:
